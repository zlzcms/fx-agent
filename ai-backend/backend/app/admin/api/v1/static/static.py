...
@router.get("/files/{data_source}/{date}/{task_id}/{filename}", dependencies=[DependsJwtAuth])
async def get_admin_static_file(data_source: str, date: str, task_id: str, filename: str):
    """获取指定的静态文件"""
...
async def list_admin_task_files(data_source: str, date: str, task_id: str):
    """列出指定任务的所有文件"""
    # 构建目录路径
