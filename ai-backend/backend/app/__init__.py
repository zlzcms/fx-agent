...
# ensure SQLAlchemy mappers are configured after all models are imported
try:
    configure_mappers()
except Exception:
    # if configuration fails here, SQLAlchemy will attempt later on first use
    # but calling early helps avoid "instance lacks instrumentation" issues
    pass
