"""add_unique_constraint_to_crm_user_id

Revision ID: 8ee6e90ec006
Revises: edd6636a4f4f
Create Date: 2025-10-28 15:02:28.654086
...
revision = "8ee6e90ec006"
down_revision = "edd6636a4f4f"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table("sys_user", schema=None) as batch_op:
        batch_op.create_index(batch_op.f("ix_sys_user_crm_user_id"), ["crm_user_id"], unique=True)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table("sys_user", schema=None) as batch_op:
        batch_op.drop_index(batch_op.f("ix_sys_user_crm_user_id"))
