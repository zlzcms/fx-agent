...
// Added for create_ai page
export const MaterialSymbolsKeyboardArrowUp = createIconifyIcon('material-symbols:keyboard-arrow-up');
export const MaterialSymbolsKeyboardArrowDown = createIconifyIcon('material-symbols:keyboard-arrow-down');
export const MaterialSymbolsDeleteOutline = createIconifyIcon('material-symbols:delete-outline');
