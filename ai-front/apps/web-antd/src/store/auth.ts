...
import { getAccessCodesApi, getCaptchaApi, getUserInfoApi, loginApi, logoutApi } from '#/api';
...
export const useAuthStore = defineStore('auth', () => {
  ...
  async function authLogin(params: Recordable<any>, onSuccess?: () => Promise<void> | void) {
    ...
    try {
      ...
      const { access_token, session_uuid } = await loginApi(params as LoginParams);
