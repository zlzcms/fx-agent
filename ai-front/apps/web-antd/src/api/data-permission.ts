...
export async function getSysDataScopeRulesApi(pk: number) {
  return requestClient.get<SysDataScopeRulesResult>(`/api/v1/sys/data-scopes/${pk}/rules`);
}
...
export async function updateSysDataScope(pk: number, data: CreateSysDataScopeParams) {
...
export async function updateSysDataRuleApi(pk: number, data: CreateSysDataRuleParams) {
