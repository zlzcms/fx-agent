...
export async function getCodeGenBusinessDetailApi(pk: number) {
  return requestClient.get<CodeGenBusinessResult>(`/api/v1/generates/businesses/${pk}`);
}

export async function getAllCodeGenBusinessApi() {
  return requestClient.get<CodeGenBusinessResult[]>('/api/v1/generates/businesses/all');
}
...
export async function updateCodeGenBusinessApi(pk: number, data: CodeGenBusinessParams) {
...
export async function getCodeGenBusinessListApi(params: QueryCodeGenBusinessParams) {
...
export async function updateCodeGenColumnApi(pk: number, data: CodeGenColumnParams) {
...
export async function importCodeGenDbTableApi(data: CodeGenBusinessImportParams) {
