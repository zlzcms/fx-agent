...
<template>
  <div class="flex flex-col items-center px-6">
    <div class="mt-6 flex w-full space-x-6">
      ...
      <div class="flex-1">
        <a-card :loading="loading" :title="$t('page.monitor.server.memory.title')">
          <div class="mt-6 flex w-full space-x-6 px-6">
            <div class="flex-1">
              <a-statistic
    ...
    <div class="mt-6 w-full space-y-6">
      <a-card :loading="loading" :title="$t('page.monitor.server.service')">
        <a-descriptions>
          <a-descriptions-item v-for="item in serviceData" :label="item.label" :key="item.label">
            {{ item.value }}
          </a-descriptions-item>
        </a-descriptions>
      </a-card>
      <a-card :loading="loading" :title="$t('page.monitor.server.system')">
        <a-descriptions size="middle" :column="4">
          <a-descriptions-item v-for="item in osData" :label="item.label" :key="item.label">
            {{ item.value }}
          </a-descriptions-item>
        </a-descriptions>
      </a-card>
